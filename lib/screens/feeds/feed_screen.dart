...
class FeedScreen extends StatelessWidget {
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                    ...
                                    InkWell(
                                      onTap: () {
                                        showBottomSheet(
                                            ...
                                            context) {
                                              return buildBottomSheet(cubit,context,i);
                                            });
                                      },
                                      child: Row(
                                        children: [
                                ...
                                cubit.comments[i].isNotEmpty? Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      CircleAvatar(
                                        radius: 14.0,
                                        backgroundImage: NetworkImage(
                                            cubit.comments[i].last.image!),
                                      ),
                                      const SizedBox(
                                        width: 20.0,
                                      ),
                                      Expanded(
                                        child: Text(cubit.comments[i].last.comment!,overflow: TextOverflow.ellipsis,),
                                      ),
                                      const SizedBox(
                                        width: 20.0,
                                      ),
  ...
  Widget buildBottomSheet(FeedsCubit cubit,context,index) => Padding(
    ...
    child: Container(
          ...
          child: cubit.comments[index].isNotEmpty ? ListView.separated(
              itemBuilder: (ctx, i) => Row(
                    children: [
                      CircleAvatar(
                        radius: 25.0,
                        backgroundImage: NetworkImage(cubit.comments[index][i].image!),
                      ),
                      const SizedBox(
                        width: 20.0,
                      ),
              ...
              itemCount: cubit.comments[index].length) : const Center(child:Text('No Comments')),
        ),
  );
}
